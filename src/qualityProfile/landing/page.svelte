<script>
  ...
  onMount(() => {
    const navItems = ["Overview", "Master List", "Profile Wizard"];
...
<div>
  ...
  <section id="overview">
    <div>
      <div class="mb-6">
        <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">⚡ Quality Profiles</h1>
      </div>

      <!-- Overview -->
      <div class="border-t border-neutral-200 dark:border-neutral-700/60 pt-6 mb-8">
        <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-3">Overview</h2>
        <Overview />
      </div>
    </div>
  </section>
  ...
  <div>
    ...
    <section id="profile-wizard" class="mt-12">
