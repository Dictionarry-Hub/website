...
import { wikiToMarkdown, type WikiMeta } from '$lib/shared/utils/llm/index.js';
...
const sources = import.meta.glob<string>('/src/routes/wiki/**/+page.svx', {
	eager: true,
	query: '?raw',
	import: 'default'
});
...
export const GET: RequestHandler = ({ params }) => {
	...
	const markdown = wikiToMarkdown(modules[path].metadata, sources[path], params.slug);
