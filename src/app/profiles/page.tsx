...
import { Info, GitBranch, Download, Library } from 'lucide-react';
...
export default async function ProfilesPage() {
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="border-b border-gray-200 dark:border-gray-700 bg-gradient-to-br from-gray-50/80 to-gray-100/50 dark:from-gray-800/90 dark:to-gray-900/80 p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            This page serves as a detailed technical reference for Dictionarry's quality profiles. While most users
            won't need this level of detail, we maintain it to be transparent about our approach to media quality
            management. Select a profile from the sidebar to view its configuration.
          </p>
        </div>
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="space-y-2">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Focused on audio/video characteristics, prioritizing lossless audio formats and HDR metadata to ensure
                  the highest quality remuxes are selected.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg">
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  ...
                  profiles use a unified definition system that compiles into specific end formats depending on the arr
                  being imported to.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg">
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  New profiles often go through beta testing in our beta branches before making their way to stable.
                  Community involvement in testing these profiles is crucial for identifying edge cases and potential
                  issues.
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-3">
                  If you encounter any issues or edge cases with profiles in beta, please report them through our GitHub
                  issues or Discord community.
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="container mx-auto">
      <ResponsiveProfileLayout profiles={profiles}>{mainContent}</ResponsiveProfileLayout>
    </div>
  );
}
