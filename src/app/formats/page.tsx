            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="border-b border-gray-200 dark:border-gray-700 bg-gradient-to-br from-gray-50/80 to-gray-100/50 dark:from-gray-800/90 dark:to-gray-900/80 p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  This page serves as a detailed technical reference for Dictionarry's custom format system. While most
                  users won't need this level of detail, we maintain it to be transparent about our approach to format
                  detection. Select a format from the sidebar to explore its implementation details.
                </p>
              </div>
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300">
                        Formats that detect various quality aspects like resolution, source type, HDR metadata, and
                        audio formats to ensure accurate quality assessment.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg">
                      <p className="text-sm text-gray-600 dark:text-gray-300">
                        Custom formats must be imported through Profilarr. Manual importing is not supported as these
                        formats use a unified definition system that compiles into specific end formats depending on the
